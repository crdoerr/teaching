...
neff_guessRe = 2.5;   % initial guess for effective index
neff_guessIm = 0.001;   % initial guess for loss component
%% grid calculations
...
%% calculate modes
[neff1,Ex1,Ey1,Ez1,Hx1,Hy1,Hz1] = modesolve_v3(lambdac,x,y,ermat,neff_guessRe, neff_guessIm, 4,'TE',1);
