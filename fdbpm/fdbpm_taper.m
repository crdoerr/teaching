...
xlimit = 4;            % window extent (xlimit = half window size)
n = ncore;
Dx = 2*xlimit/numpts;
Dkx = 2*pi/Dx/numpts;
...
[nz,nx] = simstraight(0,10,0,w1,0,0);
[nz,nx] = simtpstraight(0,taplen,0,w1,w2,nz,nx);
[nz,nx] = simstraight(0,40,0,w2,nz,nx);
zcntmax = max(size(w));
z = ((1:zcntmax) - 1)*Dz;
